...
QHash<quint32, QString> ZeraMControllerLogStrings::m_errorFlagsText;
QHash<quint32, QString> ZeraMControllerLogStrings::m_errorFlagsBootText;
...
QString ZeraMControllerLogStrings::getErrorMaskText(quint32 errorFlags, bool bootCmd)
{
    fillTextHashes();
...
void ZeraMControllerLogStrings::fillTextHashes()
{
...
void ZeraMControllerLogStrings::appendMasterErrorFlags(QHash<quint32, QString> &errorFlagsText)
{
